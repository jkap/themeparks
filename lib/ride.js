...
class Ride {
    ...
    toJSON() {
        ...
        if (this.Locations) {
            jsonData.locations = this.Locations.map(location => ({
                name: location.name,
                latitude: location.location.LatitudeRaw,
                longitude: location.location.LongitudeRaw
            }));
        }
    ...
    get Locations() {
        return this[s_locations];
    }

    set Locations(locations) {
        this[s_locations] = locations;
    }
